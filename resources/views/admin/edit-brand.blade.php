...
<div class="row">
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-body">
            {!! Form::open(['action' => ['App\Http\Controllers\BrandsController@update',$brand->id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                <div class="form-group row mb-4">
                    {{ Form::label('title', 'Title',['class' => 'col-form-label text-md-right col-12 col-md-3 col-lg-3']) }}
                    <div class="col-sm-12 col-md-7">
                        {{ Form::text('title',$brand->brand_name,['class' => 'form-control','placeholder' => 'Brand Title']) }}
                    </div>
                </div>
                ...
                <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-12 col-md-7">
                        {{ Form::url('url',$brand->url,['class' => 'form-control','placeholder' => 'Brand URL']) }}
                    </div>
                </div>
                ...
                <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-12 col-md-7">
                        {{ Form::textarea('description',$brand->description,['class' => 'form-control summernote','placeholder' => 'Brand Description']) }}
