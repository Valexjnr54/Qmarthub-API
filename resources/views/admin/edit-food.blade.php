...
<div class="row">
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-body">
            {!! Form::open(['action' => ['App\Http\Controllers\FoodsController@update',$food->id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                <div class="form-group row mb-4">
                    {{ Form::label('name', 'Food Name',['class' => 'col-form-label text-md-right col-12 col-md-3 col-lg-3']) }}
                    <div class="col-sm-12 col-md-7">
                        {{ Form::text('name',$food->name,['class' => 'form-control','placeholder' => 'Food Name']) }}
                    </div>
                </div>
                ...
                <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-12 col-md-7">
                        <select class="form-control selectric" name="vendor_id" required>
                            <option value="{!! $food->vendor->id !!}">{!! $food->vendor->name !!}</option>
                ...
                <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-12 col-md-7">
                        {{ Form::number('price',$food->price,['class' => 'form-control','placeholder' => 'Food Price']) }}
                    </div>
                </div>
                <div class="form-group row mb-4">
                    {{ Form::label('description', 'Food Description',['class' => 'col-form-label text-md-right col-12 col-md-3 col-lg-3']) }}
                    <div class="col-sm-12 col-md-7">
                        {{ Form::textarea('description',$food->description,['class' => 'form-control summernote','placeholder' => 'Vendor Location']) }}
                    </div>
                </div>
                <div class="form-group row mb-4">
                ...
                <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-12 col-md-7">
                        {{ Form::submit('Edit Food',['class' => 'btn btn-primary']) }}
                    </div>
                </div>
